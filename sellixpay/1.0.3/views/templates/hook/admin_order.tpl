    ...
    <div class="table-responsive card-body">
      <table class="table sellixpay-subtable">
         <tr>
            ...
            <td class="value"><strong>{$transaction['transaction_id']|escape:'htmlall':'UTF-8'}</strong></td>
        </tr>
        <tr>
            ...
            <td class="value">
                <strong>
                    {if $response['data']['status']}}
                        {$response['data']['status']|escape:'htmlall':'UTF-8'}
                    {else}
        ...
        <tr>
            ...
            <td class="value">{$transaction['order_notes']|escape:'htmlall':'UTF-8'}</td>
        </tr> 
       </table>
    </div>
</div>
